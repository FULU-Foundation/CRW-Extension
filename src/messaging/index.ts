...
export function createBackgroundMessageHandler(handlers: {
  onPageContextUpdated?: (payload: PageContext, sender: browser.Runtime.MessageSender) => void;
}) {
  browser.runtime.onMessage.addListener((msg: CRWMessage | any, sender: browser.Runtime.MessageSender) => {
    ...
    switch (msg.type) {
      ...
      default:
        console.warn(`${Constants.LOG_PREFIX} Unknown message type:`, msg.type);
        break;
    }
  });
}